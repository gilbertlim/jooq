...
import org.jooq.generated.tables.Actor_.ActorPath;
...
public class FilmActor_ extends TableImpl<FilmActorRecord> {
     ...
     */
    public static final FilmActor_ FILM_ACTOR = new FilmActor_();
    ...
    private FilmActor_(Name alias, Table<FilmActorRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private FilmActor_(Name alias, Table<FilmActorRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    public FilmActor_(String alias) {
    ...
    public <O extends Record> FilmActor_(Table<O> path, ForeignKey<O, FilmActorRecord> childPath, InverseForeignKey<O, FilmActorRecord> parentPath) {
     ...
     */
    public static class FilmActorPath extends FilmActor_ implements Path<FilmActorRecord> {
    ...
    @Override
    public FilmActor_ as(String alias) {
        return new FilmActor_(DSL.name(alias), this);
    }

    @Override
    public FilmActor_ as(Name alias) {
        return new FilmActor_(alias, this);
    }

    @Override
    public FilmActor_ as(Table<?> alias) {
        return new FilmActor_(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public FilmActor_ rename(String name) {
        return new FilmActor_(DSL.name(name), null);
    }
     ...
     */
    @Override
    public FilmActor_ rename(Name name) {
        return new FilmActor_(name, null);
    }
     ...
     */
    @Override
    public FilmActor_ rename(Table<?> name) {
        return new FilmActor_(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public FilmActor_ where(Condition condition) {
        return new FilmActor_(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public FilmActor_ where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public FilmActor_ where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public FilmActor_ where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public FilmActor_ where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public FilmActor_ where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public FilmActor_ where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public FilmActor_ where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public FilmActor_ whereExists(Select<?> select) {
     ...
     */
    @Override
    public FilmActor_ whereNotExists(Select<?> select) {
