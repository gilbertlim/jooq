...
import org.jooq.generated.tables.Language_.LanguagePath;
...
public class Film_ extends TableImpl<FilmRecord> {
     ...
     */
    public static final Film_ FILM = new Film_();
    ...
    private Film_(Name alias, Table<FilmRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Film_(Name alias, Table<FilmRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> Film_(Table<O> path, ForeignKey<O, FilmRecord> childPath, InverseForeignKey<O, FilmRecord> parentPath) {
     ...
     */
    public static class FilmPath extends Film_ implements Path<FilmRecord> {
    ...
    @Override
    public Film_ as(String alias) {
        return new Film_(DSL.name(alias), this);
    }

    @Override
    public Film_ as(Name alias) {
        return new Film_(alias, this);
    }

    @Override
    public Film_ as(Table<?> alias) {
        return new Film_(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Film_ rename(String name) {
        return new Film_(DSL.name(name), null);
    }
     ...
     */
    @Override
    public Film_ rename(Name name) {
        return new Film_(name, null);
    }
     ...
     */
    @Override
    public Film_ rename(Table<?> name) {
        return new Film_(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Film_ where(Condition condition) {
        return new Film_(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Film_ where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Film_ where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Film_ where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Film_ where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Film_ where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Film_ where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Film_ where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Film_ whereExists(Select<?> select) {
     ...
     */
    @Override
    public Film_ whereNotExists(Select<?> select) {
