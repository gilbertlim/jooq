...
public class Store_ extends TableImpl<StoreRecord> {
     ...
     */
    public static final Store_ STORE = new Store_();
    ...
    private Store_(Name alias, Table<StoreRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Store_(Name alias, Table<StoreRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> Store_(Table<O> path, ForeignKey<O, StoreRecord> childPath, InverseForeignKey<O, StoreRecord> parentPath) {
     ...
     */
    public static class StorePath extends Store_ implements Path<StoreRecord> {
    ...
    @Override
    public Store_ as(String alias) {
        return new Store_(DSL.name(alias), this);
    }

    @Override
    public Store_ as(Name alias) {
        return new Store_(alias, this);
    }

    @Override
    public Store_ as(Table<?> alias) {
        return new Store_(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Store_ rename(String name) {
        return new Store_(DSL.name(name), null);
    }
     ...
     */
    @Override
    public Store_ rename(Name name) {
        return new Store_(name, null);
    }
     ...
     */
    @Override
    public Store_ rename(Table<?> name) {
        return new Store_(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Store_ where(Condition condition) {
        return new Store_(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Store_ where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Store_ where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Store_ where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Store_ where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Store_ where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Store_ where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Store_ where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Store_ whereExists(Select<?> select) {
     ...
     */
    @Override
    public Store_ whereNotExists(Select<?> select) {
