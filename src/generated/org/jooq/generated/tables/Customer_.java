...
public class Customer_ extends TableImpl<CustomerRecord> {
     ...
     */
    public static final Customer_ CUSTOMER = new Customer_();
    ...
    private Customer_(Name alias, Table<CustomerRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Customer_(Name alias, Table<CustomerRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> Customer_(Table<O> path, ForeignKey<O, CustomerRecord> childPath, InverseForeignKey<O, CustomerRecord> parentPath) {
     ...
     */
    public static class CustomerPath extends Customer_ implements Path<CustomerRecord> {
    ...
    @Override
    public Customer_ as(String alias) {
        return new Customer_(DSL.name(alias), this);
    }

    @Override
    public Customer_ as(Name alias) {
        return new Customer_(alias, this);
    }

    @Override
    public Customer_ as(Table<?> alias) {
        return new Customer_(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Customer_ rename(String name) {
        return new Customer_(DSL.name(name), null);
    }
     ...
     */
    @Override
    public Customer_ rename(Name name) {
        return new Customer_(name, null);
    }
     ...
     */
    @Override
    public Customer_ rename(Table<?> name) {
        return new Customer_(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Customer_ where(Condition condition) {
        return new Customer_(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Customer_ where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Customer_ where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Customer_ where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Customer_ where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Customer_ where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Customer_ where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Customer_ where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Customer_ whereExists(Select<?> select) {
     ...
     */
    @Override
    public Customer_ whereNotExists(Select<?> select) {
