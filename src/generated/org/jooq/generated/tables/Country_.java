...
public class Country_ extends TableImpl<CountryRecord> {
     ...
     */
    public static final Country_ COUNTRY = new Country_();
    ...
    private Country_(Name alias, Table<CountryRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Country_(Name alias, Table<CountryRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> Country_(Table<O> path, ForeignKey<O, CountryRecord> childPath, InverseForeignKey<O, CountryRecord> parentPath) {
     ...
     */
    public static class CountryPath extends Country_ implements Path<CountryRecord> {
    ...
    @Override
    public Country_ as(String alias) {
        return new Country_(DSL.name(alias), this);
    }

    @Override
    public Country_ as(Name alias) {
        return new Country_(alias, this);
    }

    @Override
    public Country_ as(Table<?> alias) {
        return new Country_(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Country_ rename(String name) {
        return new Country_(DSL.name(name), null);
    }
     ...
     */
    @Override
    public Country_ rename(Name name) {
        return new Country_(name, null);
    }
     ...
     */
    @Override
    public Country_ rename(Table<?> name) {
        return new Country_(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Country_ where(Condition condition) {
        return new Country_(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Country_ where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Country_ where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Country_ where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Country_ where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Country_ where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Country_ where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Country_ where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Country_ whereExists(Select<?> select) {
     ...
     */
    @Override
    public Country_ whereNotExists(Select<?> select) {
