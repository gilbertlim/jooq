...
public class InventoryInStock_ extends AbstractRoutine<Byte> {
     ...
     */
    public InventoryInStock_() {
        super("inventory_in_stock", Sakila_.SAKILA, SQLDataType.TINYINT);
     ...
     */
    public InventoryInStock_ setPInventoryId(Field<Integer> field) {
